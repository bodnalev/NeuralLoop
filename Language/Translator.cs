...
namespace NeuralLoop.Language
{
    ...
    class Translator
    {
        ...
        public static void LoadDictionaryVoid()
        {
            collection = new Dictionary<string, BinaryWord>();
            nouns = new Dictionary<string, BinaryWord>();
            using (StreamReader reader = new StreamReader(@"D:\Edu\Programming\ML\NeuralLoop\NeuralLoop\dictionary.txt"))
        ...
        public static BinaryWord GenerateBinaryWord(string word, bool sec)
        {
            try
            {
        ...
        private static BinaryWord BinaryWordFromReader(StreamReader dicReader, string word)
        {
            string dicLine;
            bool britDic = false;
            bool firstDef = true;
